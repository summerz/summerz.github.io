...
![](./naver_news.png) 이건 [네이버 뉴스 메인](http://news.naver.com/ "[http://news.naver.com/]로 이동합니다.")

![](./daum_media.png) 이건 [다음 미디어 메인](http://media.daum.net/ "[http://media.daum.net/]로 이동합니다.") (뉴스홈이라고도 하는군요)
...
그런데, 제가 위에서는 올포스트가 새로운 미디어를 지향한다고 하면서 왜 언론사닷컴과 비교를 하지도 않고 포털과 비교를 했을까요? 제가 **[바로 이전 글에서 썼듯이](/blog/2010/05/19)** 이미 국내 언론사들의 홈페이지는 기사를 보기 힘들 정도로 망가져 있기 때문입니다.
