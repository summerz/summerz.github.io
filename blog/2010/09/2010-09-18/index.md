...
![](./사진%201.PNG) 정보가 표시된 버튼을 클릭하면 팝업이 뜹니다. 여기서 **로그아웃**을 클릭.

![](./사진%202.PNG) 그럼 정보가 표시됐던 버튼이 단순히 로그인 버튼으로 바뀌었네요. 이제 **로그인** 버튼을 클릭

![](./사진%203.PNG) 다시 팝업이 뜨면 **기존의 계정 사용**을 클릭합니다.

![](./사진%204.PNG) 다시 팝업이 뜨면 여기서 원하는 계정 정보를 입력하세요. 그럼 제대로 로그인이 될 겁니다.

![](./사진%205.PNG) 이 정도면 충분히 쉽죠. 단, 계정은 미리 만들어 두어야겠죠.
